...
// Copyright (c) 2017-2018 The Guapcoin Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Guapcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GUAP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and guapcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Guapcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Guapcoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Guapcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GUAP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GUAP addresses"));
    ...
    openAction->setStatusTip(tr("Open a guapcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Guapcoin Coin help message to get a list with possible Guapcoin Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/guapcoin_logo_horizontal").pixmap(210, 50));
    ...
    if (enableWallet) {
       ...
       if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        ...
        frameToolbar->setStyleSheet(".QFrame { margin-left:-0px; background-color: #8f802d; }");
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Guapcoin network", "", count));
}
