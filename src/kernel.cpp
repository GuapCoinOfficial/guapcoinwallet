...
int nStakeTargetSpacing = 60; // Guapcoin: 1 minute blocks during POS (block 201+)
...
{
    // Guapcoin will hash in the transaction hash and the index number in order to make sure each hash is unique
