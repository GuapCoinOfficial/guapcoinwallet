...
In order to support loading of multiple wallets in guapcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is guapcoin.cpp.
...
Changes to guapcoin.cpp
----------------------
guapcoin.cpp is the entry point into guapcoin-qt, and as such, will require some minor modifications to provide hooks for
