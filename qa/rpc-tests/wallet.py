...
#   c) node1 mines 32 blocks, so now node 0 has 500000GUAP, node 1 has 4250GUAP, node2 has none.
#   d) node0 sends 601 GUAP to node2, in two transactions (301 GUAP, then 300 GUAP).
